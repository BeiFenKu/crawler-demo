package com.dempe.crawler.qqzone.processor;

import com.dempe.crawler.qqzone.pipeline.ZanPipeline;
import com.dempe.crawler.utils.ConfigIO;
...
public class ZanProcessor implements PageProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ZanProcessor.class);
     ...
     * @return zan url
     */
    public String getZanUrl(int index) {
        return zan_url.replace("zanurl", shuoshuoid_list.get(index));
    }

    public static void main(String[] args) {
        ZanProcessor pageProcessor = new ZanProcessor();
        Spider.create(pageProcessor).thread(10)
                .addUrl(pageProcessor.getZanUrl(0))
